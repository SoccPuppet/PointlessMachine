...
object ConcreteDrier : SpellAction{
    override val argc = 1
    // I hate it here
    val concreteBlocks = arrayOf(Blocks.WHITE_CONCRETE, Blocks.ORANGE_CONCRETE, Blocks.MAGENTA_CONCRETE,
    ...
    val concretePowderBlocks = arrayOf(Blocks.WHITE_CONCRETE_POWDER, Blocks.ORANGE_CONCRETE_POWDER,
